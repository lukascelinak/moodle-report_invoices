...
$string['datefrom_help'] = 'Search and generate Invoices from selected date';
$string['dateto_help'] = 'Search and generate Invoices to selected date. 
                          Selected date is provided as Invoice Issue date in invoice generation';
$string['edit'] = 'Manage Session';
$string['actions'] = 'Actions';
$string['name'] = 'Name';
$string['idnumber'] = 'Id number';
$string['vatnumber'] = 'VAT id number';
$string['vatvalue'] = 'VAT';
...
$string['dwn_actions'] = 'smer';
$string['dwn_name'] = 'protistrana_lv_nazev';
$string['dwn_idnumber'] = 'protistrana_lv_ic';
$string['dwn_vatnumber'] = 'protistrana_lv_dic';
...
$string['dwn_vat'] = 'polozka_lv_sazbadph';
...
$string['datefrom_error'] = 'Field Date from must be lover than field Date to!';